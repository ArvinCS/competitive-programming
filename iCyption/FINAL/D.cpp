...
int main(){
	...
	BigInt left = BigInt(a), right = BigInt(b), div1 = BigInt(c), div2 = BigInt(d);
	BigInt range = (left > right ? left-right : right-left);
	BigInt total1 = range/div1, total2 = range/div2;
	
	cout << total1 + total2 - BigInt(BigInt(2) * range/(div1 * div2 / gcd(div1,div2))) << "\n";
    return 0;
}
